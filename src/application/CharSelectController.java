...
public class CharSelectController {
	...
	switch (charact) {
	case '1':
	    charSelected = this.model.jin;
	    nomPerso = charSelected.getName();
	    break;
	case '2':
	    charSelected = this.model.yoshimitsu;
	    nomPerso = charSelected.getName();
	    break;
	case '3':
	    charSelected = this.model.hitmonchan;
	    nomPerso = charSelected.getName();
	    break;
	case '4':
	    charSelected = this.model.hitmonlee;
	    nomPerso = charSelected.getName();
	    break;
	case '5':
	    charSelected = this.model.ryu;
	    nomPerso = charSelected.getName();
	    break;
	case '6':
	    charSelected = this.model.chunLi;
	    nomPerso = charSelected.getName();
	    break;
	}
	if (joueur) {
	...
	this.model = new CharSelectModel(difficulty, solo);
