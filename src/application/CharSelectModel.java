...
public class CharSelectModel implements ICharSelectModel {
	...
	ryu = new Character(5, "Ryu", 21, "../imgs/ryu.jpg", attacksRyu);
	...
	chunLi = new Character(6, "Chun-Li", 19, "../imgs/chunli.png", attacksChunLi);
	...
	jin = new Character(1, "Jin", 20, "../imgs/jin.png", attacksJin);
	...
	yoshimitsu = new Character(2, "Yoshimitsu", 18, "../imgs/yoshimitsu.png", attacksYoshimitsu);
	...
	hitmonchan = new Character(3, "Hitmonchan", 19, "../imgs/hitmonchan.png", attacksHitmonchan);
	...
	hitmonlee = new Character(4, "Hitmonlee", 18, "../imgs/hitmonlee.png", attacksHitmonlee);
    }
