...
public class CharSelectModel implements ICharSelectModel {
	...
	Character ryu = new Character("Ryu", 21, "../imgs/ryu.jpg", attacksRyu);
	...
	Character chunLi = new Character("Chun-Li", 19, "../imgs/chunli.png", attacksChunLi);
	...
	Character yoshimitsu = new Character("Yoshimitsu", 18, "../imgs/yoshimitsu.png", attacksYoshimitsu);
	...
	Character hitmonchan = new Character("Hitmonchan", 19, "../imgs/hitmonchan.png", attacksHitmonchan);
	...
	Character hitmonlee = new Character("Hitmonlee", 18, "../imgs/hitmonlee.png", attacksHitmonlee);
    }
